...
//int thresholds[16] = {530, 461, 375, 542, 475, 393, 554, 488, 411, 502, 565, 429, 257, 282, 306, 326};
...
//         if(i == 10){ mp3.play(res); digCount = 0; firstDig = 0; secDig = 0; } // if * pressed
//         if(i == 11){ mp3.pause(); }   // if # pressed
