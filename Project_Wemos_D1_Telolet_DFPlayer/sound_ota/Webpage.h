...
<html>
  ...
  <head>
    ...
    <style>
      ...
      .key { 
        margin: 3px 1px 3px 1px;
        background-color:#ffffff; box-shadow: 1px 1px 2px 0 rgba(0,0,0,0.2); 
        font: normal normal bold 17px/normal "Times New Roman", Times, serif;
        border-radius:15px; border:1px solid #ffffff; display:inline-block; cursor:pointer;
        color:#000000; font-size:14px; padding:75px 15px; text-shadow:0px 0px 0px #737373; 
      }
    </style>  
  </head>
  ...
  <body style="background-color:DodgerBlue;">
    <center>
      ...
      <div>
        ...
        <button class="tombol" onclick="window.location = 'http://'+location.hostname+'/led1/random'">Random</button>
        <button class="tombol" onclick="window.location = 'http://'+location.hostname+'/led1/next'">Next</button>
      </div>
      <br/>
      <div>
