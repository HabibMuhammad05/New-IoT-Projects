void iaiao(){
  empat(300,0);empat(300,0);satu(300,0);satu(300,0);dua(300,0);dua(300,0);satu(500,50);
  enam(300,0);enam(300,0);lima(300,0);lima(300,0);empat(600,0);
}
...
void bshark(){
  dua(600,0);tiga(600,20);lima(200,80); lima(250,50);lima(250,80);lima(100,0);lima(200,100);lima(100,0);lima(200,200);
}
