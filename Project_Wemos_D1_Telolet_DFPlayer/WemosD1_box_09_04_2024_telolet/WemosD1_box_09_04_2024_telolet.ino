...
//        Serial.println("song: " + String(SongVal));
  ...
  server.on("/loop", HTTP_GET, [] (AsyncWebServerRequest *request) { mp3.loop(SongVal); request->send(200, "text/plain", "ok"); });
