...
void handleRoot() {
  ...
  html=html+"                <br><br>"; 
  html=html+"                <input type='range' style='width:90%' id='RangeCepat' name='kecepatan' value='"+cepat+"' min='10' max='100' oninput='this.nextElementSibling.value = this.value'>"; 
  html=html+"                <output>"+cepat+"</output>mS";
  html=html+"                <br><br>"; 
  html=html+"                <label>Kecerahan Sekarang : "+bright+"</label>"; 
  html=html+"                <br><br>"; 
  html=html+"                <input type='range' style='width:90%' id='RangeCerah' name='Kecerahan' value='"+bright+"' min='0' max='15' oninput='this.nextElementSibling.value = this.value'>";
  html=html+"                <output>"+bright+"</output>"; 
  html=html+"                <br><br>"; 
  html=html+"                <label>Lama Tiap Animasi Sekarang : "+waktuAnim+"S</label>"; 
  html=html+"                <br><br>"; 
  html=html+"                <input type='range' style='width:90%' id='rangeEfek' name='Efek' value='"+waktuAnim+"' min='0' max='20' oninput='this.nextElementSibling.value = this.value'>";
