...
void handleRoot() {
  ...
  html=html+"            </tr>"; <tr>"; 
  html=html+"                <td style='width:25%'>"; 
  html=html+"                   <label><input type='checkbox' id='man1' name='man21' value='1'> 21</label>";
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man2' name='man22' value='1'> 22</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man3' name='man23' value='1'> 23</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man4' name='man24' value='1'> 24</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man5' name='man25' value='1'> 25</label>"; 
  html=html+"                </td>"; 
  html=html+"                <td style='width:25%'>"; 
  html=html+"                   <label><input type='checkbox' id='man6' name='man26' value='1'> 26</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man7' name='man27' value='1'> 27</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man8' name='man28' value='1'> 28</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man9' name='man29' value='1'> 29</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man10' name='man30' value='1'> 30</label>"; 
  html=html+"                </td>"; 
  html=html+"                <td style='width:25%'>"; 
  html=html+"                   <label><input type='checkbox' id='man11' name='man31' value='1'> 31</label>";
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man12' name='man32' value='1'> 32</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man13' name='man33' value='1'> 33</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man14' name='man34' value='1'> 34</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man15' name='man35' value='1'> 35</label>"; 
  html=html+"                </td>"; 
  html=html+"                <td style='width:25%'>"; 
  html=html+"                   <label><input type='checkbox' id='man16' name='man36' value='1'> 36</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man17' name='man37' value='1'> 37</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man18' name='man38' value='1'> 38</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man19' name='man39' value='1'> 39</label>"; 
  html=html+"                   <br>";  
  html=html+"                   <label><input type='checkbox' id='man20' name='man40' value='1'> 40</label>"; 
  html=html+"                </td>"; 
  html=html+"            </tr>"; 
  html=html+"        </table>";
  html=html+"        <table>"; 
...
//   if (tombolrem==0){ Stop_blink(slctStop); }  
//    
//   else if (tombolkiri==0){    
//       startTime1 = millis();  // Record the start time
//       outputActive1 = true;   // Set the flag to indicate output is active
...
//   }
//   
//   if (outputActive1 && (millis() - startTime1 >= 1500)) { outputActive1 = false; }
//   if (outputActive1){ panah_kiri(slctSein); }
//   
//   if (outputActive2 && (millis() - startTime2 >= 1500)) { outputActive2 = false; }
//   if (outputActive2){ panah_kanan(slctSein); }
//   
//   if ((tombolkiri == 1) && (tombolkanan == 1) && (tombolrem == 1) && (!outputActive1) && (!outputActive2)){
//     runMatrixAnimation();
//   }
